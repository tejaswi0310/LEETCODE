...
<strong>Explanation: </strong>Replace the first occurrence&nbsp;of 'B' with 'A' and form "AAAAABB"&nbsp;.<br>
The subtring "AAAAA" has the longest repeating letters , which is 5.</span></div>
